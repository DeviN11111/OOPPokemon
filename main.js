...
Pokemon.pokemonArray.push(new pikachu(name1, maxHealth, energy, attacks, weak, Resistance))
...
Pokemon.pokemonArray.push(new charmander(name1, maxHealth, energy, attacks, weak, Resistance))
